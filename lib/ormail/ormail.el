;;; ormail.el --- description -*- lexical-binding: t; -*-
;;
;; This file is not part of GNU Emacs.
;;
;;; Commentary:
;;
;;  ormail package for doom-emcs.
;;
;;; Code:
...
(map! :after notmuch
      ...
      :n "?" 'notmuch-help
      :n [return] 'ormail/tree-show-message
...
(when ormail-attachment-default-directory
  (setq mm-default-directory ormail-attachment-default-directory))
